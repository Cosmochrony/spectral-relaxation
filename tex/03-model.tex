\section{Choice of a Relaxation-Graph Model}
  \label{sec:model}

  \subsection{Requirements on the relaxation graphs}
    \label{sec:model:requirements}

    The following properties are necessary for a family $\{G(n)\}_{n \geq 1}$ to
    be consistent with the projective relaxation picture.
    ...
    The family must admit an explicit indexing compatible with the relaxation rank
    $n$.
  ...
  \subsection{Identification of the relaxation index}
