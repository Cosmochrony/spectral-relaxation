...
\date{2026\\[2pt]\small Version 2.1.2}
...
\begin{document}
  ...
  cascade rank?}
    ...
    \subsection{Position within the Cosmochrony programme}
      ...
      than saturating.
      This is a fibre-side diagnostic.  Its insertion into the O4--O6 growth equation
      is a distinct cross-substrate prescription, not a consequence of the decay
      measurement~\cite{Beau2026sgn}.
  ...
  \section{Conclusion}
    ...
    than saturates.
    The O-series measured the fibre-side exponent $\delta_{\mathrm{pair}}$ and formerly
    inserted it into the prescription
    $\beta^*=1/(\delta_{\mathrm{pair}}+\tfrac12)$~\cite{Beau2026a28,Beau2026a29}.
    The native Heisenberg audit shows that this step combines observables from different
    substrates and is not a derived capacity-to-rate law~\cite{Beau2026sgn}.
    Consequently the present LPS results identify a structural obstacle and motivate the
    Heisenberg diagnostic, but do not establish a mass-hierarchy derivation through that
    reciprocal prescription.
